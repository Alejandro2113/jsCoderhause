...
-AGREGAR LIBRERIAS SWEET ALERT Y TOSTIFY. (X)
-USO DE ASINCRONIA Y PROMESAS CON UNA API USANDO UN FETCH || USAR UN DATA.JSON PARA EMULAR UN API (X)
-BORRAR TODOS LOS CONSOLE.LOG !IMPORTANTE (X)
-ELIMINAR TODOS LOS ALERT Y MODIFICARLOS A SWEET ALERT, ELIMINAR LOS PROMPT (X)
-REVISAR EL ESTILO Y PULIR EL CSS (X)
